...
def serve_select(
    ...
    wrapped_dependencies = _create_wrapped_dependencies(dependencies)
...
def serve_union(
    ...
    # Create the route with dependencies
    @app.get(path, response_model=list[data_model], dependencies=wrapped_dependencies)
    def get(
        filters: filter_model = Depends(),
        limit: int = 100,
        offset: int = 0,
...
def _create_wrapped_dependencies(dependencies):

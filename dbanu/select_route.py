...
def serve_select(
    ...
    def create_middleware_chain():
        ...
        for middleware in reversed(middlewares):
            ...
            def make_wrapper(current_middleware, next_handler):
                def wrapper(filters: BaseModel, limit: int, offset: int, dependency_results: dict[str, Any]):
                    return current_middleware(filters, limit, offset, dependency_results, lambda: next_handler(filters, limit, offset, dependency_results))
                return wrapper
    ...
    def get(filters: filter_model = Depends(), limit: int = 100, offset: int = 0, request: Request = None):
        """

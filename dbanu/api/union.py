...
from fastapi import Body, Depends, Query, FastAPI, Request
...
def serve_union(
    ...
    async def handle_request(
        request: Request,
        filters: filter_model,  # type: ignore
        limit: int = 100,
        offset: int = 0,
    ...
    if "GET" in methods:
        @app.get(
            ...
            name=name if name is not None else f"{name}Get",
            summary=summary,
        ...
        async def get_handler(
            ...
            """Generated by DBAnu"""
            return await handle_request(request, filters, limit, offset, priority)
